export default {
    rinkeby: [
        ...
        },
        {
            ...
            amount: "300000000000000000000", // 300
        },
    ],
    goerli: [
        {
            address: "0xCA063A2AB07491eE991dCecb456D1265f842b568", // wBTC
            amount: "1000000", // 0.01
        }, 
        {
            address: "0x63bfb2118771bd0da7A6936667A7BB705A06c1bA", // LINK
            amount: "100000000000000000000", // 100
        }, 
        {
            address: "0xd35CCeEAD182dcee0F148EbaC9447DA2c4D449c4", // USDC
            amount:"300000000", // 300
        },
        {
            address: "0x5C221E77624690fff6dd741493D735a17716c26B", // DAI
            amount: "300000000000000000000", // 300
        },
    ]
}
